                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{ $dashboardData->TotalAmount }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{ $dashboardData->TotalOrderedAmount }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{ $dashboardData->TotalDeliveredAmount }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap14">
                                ...
                                <div>
                                    ...
                                    <h4>{{ $dashboardData->TotalCanceledAmount }}</h4>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        var tfLineChart = (function () {
            ...
            var chartBar = function () {
                ...
                var options = {
                    ...
                    colors: ['#2377FC', '#f17d09', '#12d529', '#ff0400'],
                    stroke: {
                        show: false,
                    },
                    xaxis: {
