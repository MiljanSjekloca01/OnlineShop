    ...
    <div class="main-content-wrap">
        <div class="flex items-center flex-wrap justify-between gap20 mb-27">
            ...
            <ul class="breadcrumbs flex items-center flex-wrap justify-start gap10">
                ...
                <li>
                    <a href="{{ route('admin.slides') }}"> <div class="text-tiny">Slider</div> </a>
                </li>
                <li>
        ...
        <div class="wg-box">
            <form action="{{ route('admin.slide.update',$slide)}}" method="POST" class="form-new-product form-style-1" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <fieldset class="name">
